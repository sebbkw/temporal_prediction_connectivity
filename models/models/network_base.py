...
import losses.hierarchical_st_autoencoder as hierarchical_st_autoencoder
...
NetworkBase.loss_hierarchical_st_autoencoder       = hierarchical_st_autoencoder.hierarchical_st_autoencoder
